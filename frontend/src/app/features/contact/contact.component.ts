  ...
  template: `
    <section>
      <div>
        ...
        <p>
          برای مشاوره انتخاب محصول، استعلام قیمت، بررسی موجودی و ثبت سفارش مستقیم با
      ...
      <div class="cards">
        ...
        @if (site.hasWhatsApp()) {
          <a [href]="site.whatsAppLink('سلام، می‌خواستم درباره محصولات نورستان اطلاعات بگیرم.')"
            ><small>واتساپ</small><b>ارسال پیام مستقیم</b><i>←</i></a
          >
        }
        @if (site.hasEmail()) {
          <a [href]="site.mailLink('استعلام از نورستان')"
            ><small>پست الکترونیک</small><b class="ltr">{{ site.site().email }}</b
            ><i>←</i></a
          >
        }
