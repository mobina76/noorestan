...
<section class="hero">
  <div class="hero-grid">
    <div class="hero-copy">
      ...
      <p>{{ site.site().businessNameFa }} با شناخت فنی محصولات مازی‌نور، شما را برای انتخاب راهکار روشنایی مناسب پروژه همراهی می‌کند.</p>
      <div class="actions">
...
@if (categories().length) {
  <section id="categories" class="section">
    <div class="heading"><div><span class="eyebrow">دسته‌بندی محصولات</span><h2>راهکار روشنایی برای هر فضا</h2></div><a routerLink="/products">همه محصولات ←</a></div>
    <div class="category-grid">
      @for (category of categories(); track category.slug) {
        <a [routerLink]="['/products']" [queryParams]="{ category: category.slug }" class="category">
...
@if (featured().length) {
  <section class="section featured">
    <div class="heading"><div><span class="eyebrow">منتخب نورستان</span><h2>محصولات شاخص</h2></div></div>
...
<section class="section why">
  <div class="why-copy">
    ...
    <div class="reasons">
      <article><b>۰۱</b><h3>مشاوره فنی</h3><p>انتخاب آگاهانه بر پایه کاربرد، نور و مشخصات پروژه.</p></article>
      <article><b>۰۲</b><h3>محصولات معتبر</h3><p>دسترسی به سبد حرفه‌ای محصولات روشنایی مازی‌نور.</p></article>
      <article><b>۰۳</b><h3>پاسخ‌گویی مستقیم</h3><p>استعلام قیمت، موجودی و سفارش از مسیر ارتباطی روشن.</p></article>
    </div>
  </div>
</section>

<section class="contact-band">
  <div><span class="eyebrow">شروع یک گفت‌وگوی روشن</span><h2>برای پروژه بعدی کنار شما هستیم.</h2></div>
  <div><p>برای دریافت مشاوره، استعلام قیمت و بررسی موجودی محصولات با {{ site.site().businessNameFa }} تماس بگیرید.</p><a routerLink="/contact">تماس با نورستان <span>←</span></a></div>
</section>
`,
